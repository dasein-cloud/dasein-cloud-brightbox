...
public class RESTMethod {
    static private final Logger logger = BrightBoxCloud.getLogger(RESTMethod.class);
    static private final Logger wire   = BrightBoxCloud.getWireLogger(RESTMethod.class);
    ...
    public RESTMethod(@Nonnull BrightBoxCloud provider) {
